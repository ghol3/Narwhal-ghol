...
class Arrays
{
	 ...
	 * @return type
	 */
	public static function sortByKeyDESC($array)
	{
	    if(count($array) < 1)
	    {
		return array();
	    ...
	    $sortArray = array();
	    $minimal_value = min(array_keys($array));
	    $sortArray[] = $array[$minimal_value];
	    unset($array[$minimal_value]);
	 ...
	 * @return type
	 */
	public static function sortByKeyASC($array)
	{
	    if(count($array) < 1)
	    {
		return array();
	    ...
	    $sortArray = array();
	    $maximal_value = max(array_keys($array));
	    $sortArray[] = $array[$maximal_value];
	    unset($array[$maximal_value]);
	    foreach($array as $arg)
	    {
		$maximal_value = max(array_keys($array));
		$sortArray[] = $array[$maximal_value];
