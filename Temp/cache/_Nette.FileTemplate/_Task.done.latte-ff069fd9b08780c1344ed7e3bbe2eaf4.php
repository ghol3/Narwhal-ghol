<?php //netteCache[01]000407a:2:{s:4:"time";s:21:"0.37729200 1408021244";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:93:"/Applications/XAMPP/xamppfiles/htdocs/Narwhal/Blacklist/AdminModule/templates/Task/done.latte";i:2;i:1407219412;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:22:"released on 2014-03-17";}}}?><?php

// source file: /Applications/XAMPP/xamppfiles/htdocs/Narwhal/Blacklist/AdminModule/templates/Task/done.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'dtudbiehfw')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbad0c1a8ec6_content')) { function _lbad0c1a8ec6_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>    <div class="heading"><?php print(STR_287) ?></div>
	...
	<table cellpadding="0" cellspacing="0" class="mytable" id="table" style="margin-top:20px;margin-left:15px">
		...
		<tr style="font-size:11px">
                    ...
                    <td align="center"><?php print(STR_XX4) ?></td>
...
" style="display:block;padding:10px 6px"><img src="<?php echo htmlSpecialChars(Nette\Templating\Helpers::safeUrl($basePath)) ?>/images/admin/edit.gif" alt="Upravit"></a>
                    ...
                    <td align="center"><?php echo Nette\Templating\Helpers::escapeHtml($task->getDoneObject()->account, ENT_NOQUOTES) ?></td>
...
<span style="color:red">NE</span><?php } ?></td>
                    <td align="center"><?php if ($task->image == '') { ?><span style="color:red">NE</span><?php } else { ?>
<span style="color:green">ANO</span><?php } ?></td>
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb5fc7ee6625_head')) { function _lb5fc7ee6625_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
