<?php //netteCache[01]000407a:2:{s:4:"time";s:21:"0.47193600 1407964277";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:93:"/Applications/XAMPP/xamppfiles/htdocs/Narwhal/Blacklist/AdminModule/templates/User/edit.latte";i:2;i:1406824550;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:22:"released on 2014-03-17";}}}?><?php

// source file: /Applications/XAMPP/xamppfiles/htdocs/Narwhal/Blacklist/AdminModule/templates/User/edit.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, '8r7d5sn4fu')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe364ce9644_content')) { function _lbe364ce9644_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>        <form<?php Nette\Latte\Macros\FormMacros::renderFormBegin($form = $_form = $_control["editform"], array (
), FALSE) ?>>
            <div class="heading"><?php print(STR_275) ?> - <?php echo Nette\Templating\Helpers::escapeHtml($user->account, ENT_NOQUOTES) ?></div>
            <div style="float:right"><input type="submit" style="font-weight:bold;color:#005400;padding:7px" value="<?php print(STR_100) ?>
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb8b533d11ff_head')) { function _lb8b533d11ff_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
